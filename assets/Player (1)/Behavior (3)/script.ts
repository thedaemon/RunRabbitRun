// Sets the gravity affecting the player
Sup.ArcadePhysics2D.setGravity(0, -0.025);

// Defines all of the player's behaviors. For instance: movement, animations, and sounds.
class PlayerBehavior extends Sup.Behavior {
  speed = 0.25;
  jumpSpeed = 0.45;

// Called once per game update. Default is 60 times a second.
  update() {
